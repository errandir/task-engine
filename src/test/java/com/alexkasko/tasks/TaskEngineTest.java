...
public class TaskEngineTest {
    ...
    private final TaskEngine taskService = new TaskEngine(MoreExecutors.sameThreadExecutor(), dao, new ProcessorProvider());
...
//        assertEquals("Events size fail", 25, events.size());
    ...
    private class DataProcessor implements TaskStageProcessor {
        ...
        public void process(long taskId) throws Exception {
            ...
            events.add("DataProcessor.task." + taskId);
        }
    }
    ...
    private class TaskDAOImpl implements TaskManager<TestTask> {
        ...
        public void updateStage(long taskId, String stage) {
            ...
            events.add("TaskDAO.task." + taskId + ".stage." + stage);
        }
